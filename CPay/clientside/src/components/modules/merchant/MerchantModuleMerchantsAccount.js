...
class MerchantModuleMerchantAccouunt extends React.Component{
    ...
    dialogMerchantSettings() {
        const { merchatSettingsDialogStateClosed } = this.state;
        return (
            <Dialog
                ...
                <div className="f-full" style={{margin: "5px"}}>
                    <MerchantModuleSettings
                        merchant_id={this.state.selected_merchant_id} />
                </div>
