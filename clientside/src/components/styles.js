...
const styles = {
  ...
  // Expander rows
  expanderRow:          'tw-px-ios-lg tw-pt-ios-lg tw-pb-ios-md tw-bg-cpay-bgSecondary tw-rounded-ios-md',
  ...
  // Code / log block
  commonBlockText: 'tw-m-ios-sm tw-overflow-x-auto tw-p-ios-md tw-bg-cpay-gray6 tw-border tw-border-cpay-separator tw-rounded-ios-md tw-font-mono tw-text-[13px] tw-text-cpay-label tw-w-[400px]',
