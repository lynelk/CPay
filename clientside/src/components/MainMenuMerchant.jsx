...
import { Messager, Menu, MenuItem, MenuSep } from 'rc-easyui';
...
class MainMenuMerchantWithOutRouter extends React.Component {
  constructor(props) {
    super(props);
    this.state = { value: null, loader: false, progressValue: 0 }
  }
    ...
    return (
        <div>
            <Menu inline onItemClick={this.handleItemClick.bind(this)}>
                ...
                <MenuItem value="channels" text="Payment Channels" iconCls="icon-more"></MenuItem>
