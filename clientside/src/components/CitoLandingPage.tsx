      ...
      <main id="top">
        ...
        <section className="cito-section cito-how">
          ...
          <ol className="cito-steps">
            <li><span>01</span><div><h3>Choose your Cito account path</h3><p>Merchants self-register; privileged users submit a controlled access request.</p></div></li>
            <li><span>02</span><div><h3>Complete verification and approval</h3><p>Finish the identity, business, email, and authorization requirements appropriate to your account.</p></div></li>
            <li><span>03</span><div><h3>Configure and test</h3><p>Approved merchants connect supported payment channels and validate integrations in sandbox.</p></div></li>
        ...
        <section className="cito-section cito-access" id="access">
          <div className="cito-section-heading cito-section-heading-center"><p className="cito-eyebrow">Access Cito</p><h2>One public front door for every approved account.</h2><p>Cito directs each person to the correct authentication or onboarding realm without allowing public privilege self-assignment.</p></div>
          <div className="cito-access-grid">
            <article><p className="cito-card-label">Need an account?</p><h3>Start through Cito.</h3><p>Businesses can self-register. Administrators, staff, specialists, and partners can securely request controlled access for review.</p><Link className="cito-button cito-button-primary" to={SIGN_UP_PATH}>Get started</Link></article>
            <article><p className="cito-card-label">Already approved?</p><h3>Sign in through Cito.</h3><p>Choose the account context issued to you. Your authenticated account and permissions determine the modules you can access.</p><Link className="cito-button cito-button-secondary" to={SIGN_IN_PATH}>Sign in to Cito</Link></article>
          </div>
        </section>
