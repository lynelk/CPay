...
import net.citotech.cito.balance.ChannelBalance;
import net.citotech.cito.balance.ChannelBalanceService;
...
public class MerchantSelfServiceController {
    ...
    private final ChannelBalanceService channelBalanceService;
    private final TransactionRepository transactionRepository;

    public MerchantSelfServiceController(V2RequestSecurityService securityService,
                                         ChannelBalanceService channelBalanceService,
                                         TransactionRepository transactionRepository) {
        this.securityService = securityService;
        this.channelBalanceService = channelBalanceService;
    ...
    public ResponseEntity<?> balances(@RequestParam("merchantNumber") String merchantNumber,
        ...
        try {
            ...
            List<ChannelBalance> balances = channelBalanceService.getBalances(merchant);
