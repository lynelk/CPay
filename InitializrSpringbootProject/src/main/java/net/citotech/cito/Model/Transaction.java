...
public class Transaction {
    ...
    public void setFinalStatusSet(boolean finalStatusSet) { isFinalStatusSet = finalStatusSet; }
    public String getSafaricomRequestReference() { return safaricomRequestReference; }
    public void setSafaricomRequestReference(String safaricomRequestReference) { this.safaricomRequestReference = safaricomRequestReference; }
    public String getOriginate_ip() { return originate_ip; }
    public void setOriginate_ip(String originate_ip) { this.originate_ip = originate_ip; }
    ...
    public String getCallback_trace() { return callback_trace; }
    public void setCallback_trace(String callback_trace) { this.callback_trace = callback_trace; }
    ...
    public Long getMerchant_batch_transactions_log_id() { return merchant_batch_transactions_log_id; }
    public void setMerchant_batch_transactions_log_id(Long merchant_batch_transactions_log_id) { this.merchant_batch_transactions_log_id = merchant_batch_transactions_log_id; }
    ...
    public void setCharging_method(String charging_method) { this.charging_method = charging_method; }
    public String getTx_request_trace() { return tx_request_trace; }
    public void setTx_request_trace(String tx_request_trace) { this.tx_request_trace = tx_request_trace; }
    public String getTx_update_trace() { return tx_update_trace; }
    public void setTx_update_trace(String tx_update_trace) { this.tx_update_trace = tx_update_trace; }
    public String getTx_description() { return tx_description; }
    public void setTx_description(String tx_description) { this.tx_description = tx_description; }
    public String getTx_merchant_description() { return tx_merchant_description; }
    public void setTx_merchant_description(String tx_merchant_description) { this.tx_merchant_description = tx_merchant_description; }
    public String getTx_unique_id() { return tx_unique_id; }
    public void setTx_unique_id(String tx_unique_id) { this.tx_unique_id = tx_unique_id; }
    public String getTx_gateway_ref() { return tx_gateway_ref; }
    public void setTx_gateway_ref(String tx_gateway_ref) { this.tx_gateway_ref = tx_gateway_ref; }
    public String getTx_merchant_ref() { return tx_merchant_ref; }
    public void setTx_merchant_ref(String tx_merchant_ref) { this.tx_merchant_ref = tx_merchant_ref; }
    ...
    public String getPayer_number() { return payer_number; }
    public void setPayer_number(String payer_number) { this.payer_number = payer_number; }
    public String getResolved_by() { return resolved_by; }
    public void setResolved_by(String resolved_by) { this.resolved_by = resolved_by; }
