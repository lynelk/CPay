...
CREATE TABLE IF NOT EXISTS finance_settlement_batches (
    ...
    gross_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
    fee_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
    tax_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
    adjustment_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
    net_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
    variance_amount DECIMAL(24, 6) NOT NULL DEFAULT 0,
...
CREATE INDEX idx_finance_settlement_batches_status
    ON finance_settlement_batches(status);
CREATE INDEX idx_finance_settlement_batches_business_date
    ON finance_settlement_batches(business_date);
CREATE INDEX idx_finance_settlement_batches_merchant
    ON finance_settlement_batches(merchant_id);
CREATE INDEX idx_finance_settlement_batches_provider
...
CREATE TABLE IF NOT EXISTS finance_settlement_items (
    ...
    CONSTRAINT fk_finance_settlement_item_batch FOREIGN KEY (settlement_batch_id) REFERENCES finance_settlement_batches(id) ON DELETE CASCADE
);

CREATE INDEX idx_finance_settlement_items_batch
    ON finance_settlement_items(settlement_batch_id);
CREATE INDEX idx_finance_settlement_items_reference
...
CREATE TABLE IF NOT EXISTS treasury_positions (
    ...
    pending_payout_exposure DECIMAL(24, 6) NOT NULL DEFAULT 0,
    unsettled_receivable DECIMAL(24, 6) NOT NULL DEFAULT 0,
    unsettled_payable DECIMAL(24, 6) NOT NULL DEFAULT 0,
    unreconciled_exposure DECIMAL(24, 6) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS reconciliation_exceptions (
    ...
    provider_amount DECIMAL(24, 6),
    variance_amount DECIMAL(24, 6),
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_reconciliation_exception_batch FOREIGN KEY (settlement_batch_id) REFERENCES finance_settlement_batches(id),
...
CREATE INDEX idx_reconciliation_exceptions_batch
...
CREATE INDEX idx_finance_report_exports_type
...
CREATE INDEX idx_operations_incidents_status
...
CREATE TABLE IF NOT EXISTS operations_incident_events (
    ...
    metadata JSON NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_operations_incident_event_incident FOREIGN KEY (incident_id) REFERENCES operations_incidents(id) ON DELETE CASCADE
);

CREATE INDEX idx_operations_incident_events_incident
