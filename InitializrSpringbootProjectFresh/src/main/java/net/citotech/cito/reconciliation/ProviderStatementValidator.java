...
public class ProviderStatementValidator {
    ...
    public ProviderStatementValidator(
            ProviderStatementParserRegistry parserRegistry,
    ...
    private long save(
        ...
        String sql =
                "INSERT INTO provider_statement_validation_runs (provider_code, channel_code, file_name, validation_status, total_rows, valid_rows, invalid_rows, duplicate_rows, message) VALUES (:provider_code, :channel_code, :file_name, :status, :total, :valid, :invalid, :duplicates, :message)";
