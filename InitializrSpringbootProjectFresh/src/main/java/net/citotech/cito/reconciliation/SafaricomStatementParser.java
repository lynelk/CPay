...
/**
 * Safaricom M-Pesa statement parser (audit O1). M-Pesa statement exports commonly use
 * "Receipt No." and "Completion Time" rather than the generic "reference"/"date" aliases the other
 * providers share — added here as extra, case-insensitive aliases (not a replacement) since this is
 * a genuinely different, provider-specific column convention. This is based on commonly documented
...
public class SafaricomStatementParser extends AbstractTabularStatementParser {
    ...
    protected Map<String, String[]> columnAliases() {
        ...
        aliases.put("providerReference", concat(aliases.get("providerReference"), "receipt no.", "receipt no", "receipt number"));
