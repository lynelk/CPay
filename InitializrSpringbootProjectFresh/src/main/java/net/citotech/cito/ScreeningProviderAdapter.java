 ...
 *
 * Implementations must not embed provider credentials. Live provider adapters should be activated by
 * configuration only after certification and credential provisioning are complete.
 */
