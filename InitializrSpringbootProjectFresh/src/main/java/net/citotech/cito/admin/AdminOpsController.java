...
public class AdminOpsController {
    ...
    public String seedDefaults() {
        permissions.require(
                "ADMIN_PERMISSION_MANAGE", "seed-default-permissions", "admin_permissions");
    ...
    public Map<String, Object> reencryptMerchantKey(@RequestParam("merchantId") long merchantId) {
