 ...
 * dead code. {@link MethodSecurityEnforcementTest} separately proves the annotation actually fires
 * through Spring's AOP method-security proxy, not just that it is present as text.
 */
class AdminControllerPreAuthorizeCoverageTest {

    private static final List<Class<?>> ADMIN_ROLE_GUARDED_CONTROLLERS =
            List.of(
