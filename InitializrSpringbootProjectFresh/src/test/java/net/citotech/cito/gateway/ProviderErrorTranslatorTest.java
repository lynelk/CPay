 ...
 * never echoes the raw provider text, plus internal-exception cases must get a stable,
 * non-sensitive reason code rather than the raw exception message.
 */
class ProviderErrorTranslatorTest {
    ...
    void a401Or403IsAuthInvalidNotRetryable() {
        assertThat(
                        ProviderErrorTranslator.translateProviderResponse(
                                        401, "{\"raw\":\"secret internal detail\"}")
                                .stableCode())
                .isEqualTo("AUTH_CREDENTIALS_INVALID");
        Translation translation =
                ProviderErrorTranslator.translateProviderResponse(403, "forbidden");
    ...
    void a408Or429Or5xxIsRetryableProviderUnavailable() {
        assertThat(ProviderErrorTranslator.translateProviderResponse(408, "timeout").stableCode())
                .isEqualTo("PROVIDER_TIMEOUT");
        assertThat(
                        ProviderErrorTranslator.translateProviderResponse(429, "rate limited")
                                .retryable())
                .isTrue();
        assertThat(
                        ProviderErrorTranslator.translateProviderResponse(503, "unavailable")
                                .stableCode())
                .isEqualTo("PROVIDER_TIMEOUT");
    }
    ...
    void aGeneric4xxIsProviderDeclinedAndNeverLeaksTheRawBody() {
        ...
        assertThat(translation.retryable()).isFalse();
        assertThat(translation.merchantMessage())
                .doesNotContain(rawBody)
                .doesNotContain("insufficient_balance_on_provider_side_account_12345");
    }
    ...
    void a2xxWithABusinessDeclineSignalIsProviderDeclined() {
        ...
        Translation translation =
                ProviderErrorTranslator.translateProviderResponse(
                        200, "{\"result_code\":\"ESB000010\"}", "ESB000010");
    ...
    @Test
    void
            signatureVerificationFailedIsItsOwnDistinctNonRetryableAuthenticationCategoryTranslation() {
    ...
    void internalIoExceptionIsClassifiedAsARetryableProviderConnectionError() {
        Translation translation =
                ProviderErrorTranslator.translateInternalFailure(
    ...
    void internalJsonExceptionGetsAStableSystemReasonCodeNeverTheRawMessage() {
        String reasonCode =
                ProviderErrorTranslator.internalReasonCode(
                        new org.json.JSONException(
                                "Unterminated string at character 42 of {\"secret_field\":\"leak"));
    ...
    void internalCryptoExceptionGetsAStableSystemReasonCode() {
        assertThat(
                        ProviderErrorTranslator.internalReasonCode(
                                new java.security.GeneralSecurityException("bad key")))
    ...
    void unknownInternalExceptionFallsBackToAGenericSystemReasonCode() {
        ...
        assertThat(ProviderErrorTranslator.internalReasonCode(null))
                .isEqualTo("SYSTEM_UNKNOWN_ERROR");
    }
