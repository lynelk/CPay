    ...
    void localProviderRecordsScreeningRequestAndReturnsRequestId() {
        ...
        when(jdbcTemplate.query(
                        ...
                        org.mockito.ArgumentMatchers
                                .<RowMapper<ScreeningProviderAdapterRegistry.ProviderConfig>>any(),
                        org.mockito.ArgumentMatchers.<Object[]>any()))
                .thenReturn(List.of());
        when(jdbcTemplate.queryForObject("SELECT LAST_INSERT_ID()", Long.class)).thenReturn(91L);
        ScreeningProviderAdapterRegistry registry =
                new ScreeningProviderAdapterRegistry(
                        jdbcTemplate, List.of(new LocalScreeningProviderAdapter()));

        ScreeningProviderAdapterRegistry.ScreeningResult result =
                registry.screen(
        ...
        verify(jdbcTemplate)
                .update(
                        org.mockito.ArgumentMatchers.contains("screening_provider_requests"),
