...
class MerchantSelfServiceSignupServiceTest {
    ...
    @Test
    void signupGrantsPortalPaymentSmsAndPublicSmsAccess() {
        ...
        List<String> privileges = updateParams.stream()
            ...
            .map(params -> (String) params.getValue("privilege"))
            .toList();

        assertThat(privileges)
            .contains("ACCESS_MERCHANT", "MANAGE_CHANNELS", "VIEW_TRANSACTIONS", "CREATE_BATCH_TX", "ACCESS_SMS_LOG", "SEND_SMS");
    }
}
